...
public class Miles implements Serializable
{
    ...
    private final static long serialVersionUID = -6863526118391401326L;
    ...
    public String toString() {
        ...
        sb.append(Miles.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
