...
public class Kilometers implements Serializable
{
    ...
    private final static long serialVersionUID = -350442115771889384L;
    ...
    public String toString() {
        ...
        sb.append(Kilometers.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
