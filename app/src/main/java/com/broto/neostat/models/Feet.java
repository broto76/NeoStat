...
public class Feet implements Serializable
{
    ...
    private final static long serialVersionUID = -805912197115337462L;
    ...
    public String toString() {
        ...
        sb.append(Feet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
